...
<head>
    <meta charset="UTF-8">
    <title>環境管理画面 - 教室詳細（ワイドフィット版）</title>
...
<div class="detail-container">
    ...
    <div class="footer-btns">
        <a href="home_l.php" class="nav-btn">トップページへ戻る</a>
...
<script>
    ...
    // ▼▼▼ 追加した部分：5秒後に home_l.php へ移動 ▼▼▼
    setTimeout(function() {
        window.location.href = 'home_l.php';
    }, 5000);
    // ▲▲▲ 追加した部分 ▲▲▲
</script>
</body>
